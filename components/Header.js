...
const Header = () => {
  ...
  return (
    <div className=" py-3 px-3 shadow-2 flex align-items-center justify-content-between sticky top-0 h-3rem headerGlobal">
      {/* BUTTON MENU */}
      <motion.div
      ...
      >
        <a
          ref={btnBars}
          className="p-ripple cursor-pointer block lg:hidden text-yellow-100"
        >
        ...
        <ul className="list-none p-0 m-0 flex lg:align-items-center select-none flex-column lg:flex-row">
          <li className="border-top-1 border-yellow-400 lg:border-top-none">
            <a
              ...
              target={"_blank"}
              className="p-ripple flex px-6 p-3 lg:px-3 lg:py-2 align-items-center hover:bg-yellow-200 font-medium border-round cursor-pointer transition-colors transition-duration-150 w-full"
              rel="noreferrer"
            >
