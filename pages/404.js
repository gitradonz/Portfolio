...
export default function FourOhFour() {
  return (
    <div className="bg-gray-100 px-2 py-6 md:px-6 lg:px-8 pnf404">
      <div className="shadow-2 border-round bg-yellow-50 px-4 md:px-6 py-6">
        ...
        <ul className="list-none px-0 pb-0 pt-4 m-0 border-top-1 surface-border">
          <li className="py-2">
            <Link href="/">
              <a className="cursor-pointer flex align-items-center border-round border-1 hover:bg-yellow-200 border-transparent hover:border-300 p-3 transition-colors transition-duration-150">
                ...
                <div className="ml-3">
                  <span className="text-900 font-medium text-2xl mb-3">
                    Home
                  </span>
          ...
          <li className="pt-2">
            <Link href="/contact">
              <a className="cursor-pointer flex align-items-center border-round border-1 border-transparent hover:border-300 hover:bg-yellow-200 p-3 transition-colors transition-duration-150">
                <span
                  className="inline-flex align-items-center justify-content-center border-round flex-shrink-0"
                  style={{ height: "52px", width: "52px" }}
                >
